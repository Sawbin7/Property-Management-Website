    ...
    <footer className="bg-gray-800 text-white py-10 px-5">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <p className="text-gray-400">Building your future, one property at a time.</p>
        </div>

        {/* Center: Navigation Links */}
        <div className="flex flex-col items-center">
          <h2 className="font-semibold text-xl mb-3">Quick Links</h2>
          <Link to="/" className="hover:text-gray-300 mb-1">Home</Link>
          <Link to="/properties" className="hover:text-gray-300 mb-1">Properties</Link>
